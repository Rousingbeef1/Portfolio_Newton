...
export default function Servicos(){
    ...
    return(
        <section className=" flex flex-col items-center py-10 bg-[#f7f3ff]">
            <h2 className="font-poppinssemibold text-center text-black text-5xl pb-8 ">SERVIÇOS</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 bg-slat h-4/5 w-4/5 max-w-[1500px] gap-20">
