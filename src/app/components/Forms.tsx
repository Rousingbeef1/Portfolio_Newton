...
export default function Forms() {
    ...
    // Função para prevenir o comportamento padrão de envio do formulário
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault(); // Previne o envio do formulário e o recarregamento da página
    };
        ...
        <section id="Contatos" className="w-screen overflow-hidden">
            <div className="bg-[#240024] w-screen py-40 ">
                <div className="w-min mx-auto flex flex-col justify-center items-center">
                    <h2 className="flex justify-center items-center mx-auto w-min text-5xl pb-14 font-poppinssemibold text-white">
                        CONTATOS
                    </h2>
                    <div className="flex justify-center bg-gra w-[60vw] ">
                        <div className="flex flex-col items-center justify-center flex-wrap w-full ">
                            <form
                                className="grid grid-cols-4 w-full md:w-[50%] gap-3 min-w-[10px]"
                                action=""
                                method="post"
                                onSubmit={handleSubmit} // Adiciona a função de submit
                            >
                                <input
                                    className="rounded-md h-8 col-span-2 px-2 py-5 text-black"
                                    type="text"
                                    placeholder="Nome"
                                />
                                <input
                                ...
                                />
                                <input
                                    className="rounded-md h-12 col-span-4 px-2 pb-14 pt-5 text-black"
                                    type="text"
                                    name=""
                                    id=""
                                ...
                                />
                                <button
                                    className="mt-2 h-10 col-span-4 bg-white text-[#b5b5b5] hover:bg-green-300 hover:text-white rounded-md p-2"
                                    type="submit"
                                >
                                    Enviar
                                </button>
                            ...
                            <div className="flex gap-8 mt-6">
                                <div className="">
                                    <Link className="w-fit" href={'https://wa.me/559591624873'}>
                                        <Image
                                            onMouseOver={() => setAtivar(!ativar)}
                                            onMouseLeave={() => setAtivar(!ativar)}
                                            src={imagem}
                                            alt=""
                                            width={60}
                                            height={60}
                                ...
                                <div>
                                    <Link href={'https://www.instagram.com/_niutin_/'}>
                                        <Image
                                            onMouseOver={() => setInstaCheca(!instaCheca)}
                                            onMouseLeave={() => setInstaCheca(!instaCheca)}
                                            src={imagem2}
                                            alt=""
                                            width={60}
                                            height={60}
